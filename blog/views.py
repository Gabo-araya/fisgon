...
from blog.forms import Article_Form, Category_Form, Image_Article_Form
...
#=======================================================================================================================================
# Vistas para Imágenes de Artículos
#=======================================================================================================================================

@login_required(login_url='entrar')
def listar_imagen_articulos(request, *args, **kwargs):
    '''Lista imágenes de artículos.'''
    ...
    context = {
        'page' : 'Imágenes de Artículos',
        'icon' : 'bx bx-file',
        'info_usuario': info_usuario,
        'singular' : 'imagen de artículo',
        'plural' : 'imágenes de artículos',
        'url_listar' : 'listar_imagen_articulos',
        'url_crear' : 'crear_imagen_articulo',
        'url_ver' : 'ver_imagen_articulo',
        'url_editar' : 'modificar_imagen_articulo',
        'url_eliminar' : 'eliminar_imagen_articulo',
        'success_create': success_create,
        'success_edit': success_edit,
        'success_delete': success_delete,
        'object_list': object_list
...
@login_required(login_url='entrar')
def ver_imagen_articulo(request, id, *args, **kwargs):
    '''Detalle de imagen de artículo.'''
    ...
    context = {
        'page' : 'Detalle de Imagen de Artículo',
        'icon' : 'bx bx-file',
        'info_usuario': info_usuario,
        'singular' : 'imagen de artículo',
        'plural' : 'imágenes de artículos',
...
@login_required(login_url='entrar')
def crear_imagen_articulo(request, *args, **kwargs):
    '''Crear imagen de artículo.'''
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            base_url = reverse('listar_imagen_articulos')
            query_string =  urlencode({'success_create': 'OK'})
            url = '{}?{}'.format(base_url, query_string)
            return redirect(url)
            #return redirect('listar_imagen_articulos')

    info_usuario = info_header_user(request)

    context = {
        'page' : 'Crear Imagen de Artículo',
        'icon' : 'bx bx-file',
        'info_usuario': info_usuario,
        'singular' : 'imagen de artículo',
        'plural' : 'imágenes de artículos',
...
@login_required(login_url='entrar')
def modificar_imagen_articulo(request, id, *args, **kwargs):
    '''Editar imagen de artículo.'''
    ...
    context = {
        'page' : 'Editar Imagen de Artículo',
        'icon' : 'bx bx-file',
        'info_usuario': info_usuario,
        'singular' : 'imagen de artículo',
        'plural' : 'imágenes de artículos',
...
@login_required(login_url='entrar')
def eliminar_imagen_articulo(request, id, *args, **kwargs):
    ...
    context = {
        'page' : 'Eliminar Imagen de Artículo',
        'icon' : 'bx bx-file',
        'info_usuario': info_usuario,
        'singular' : 'imagen de artículo',
        'plural' : 'imágenes de artículos',
